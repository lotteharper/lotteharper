...
CRYPTO_CURRENCIES = ['ETH','BTC','ALPH','BCH','LTC','ADA','LINK','USDT','USDC','MATIC','XRP','SOL','DOGE','DASH','XNO','VET','DGB','SHIB','TRX','UNI','XMR','GAS','GRS','FUN','AXS','MX','AVAX','FEG','ARB','FTT','ZEC','XVG','LEASH','ATOM','BTG','KNC','XLM','NEO','FIRO','BCD','DCR','WABI','BAT','QTUM','BEAM','HT','RVN','OMG','AVA','ARPA','XYO','SXP','BEL','FLUF','XDC','BONE','BLOCKS','NEAR','LSK','ARK','ZIL','ALGO','LUNA','DAO','XYM','DOT','FTM','EGLD','ICX','CSPR','MANA','CHR','LUNA','SAND','OM','KLV','SCRT','SRK','CAKE','IOTX','HOT','THETA','HOGE','SUPER','VIB','MIOTA','KEANU','TRVL','POODL','RACA','POOLZ','BRISEBSC','KLAY','CNS','PIT','RBIF','LUNC','1INCH','ARV','AVAX','GALA','KIBA','BTT','BOBA','JASMY','BTT','ILV','SFUND','SHIBBSC','BIFI','GAFA','PIKAETH','XCAD','GGTKN','DGMOON','HOTCROSS','GALBSC','TTC','GRT','QUACK','DIVI','ZBCSOL','GUARD','APE','TON','TOMOERC20','ONIGI','FITFIARC20','KAS','BRISEMAINNET','NFAI','PLS','SEI','ETHARB','PEPE','NOT','ZKSYNC','XAUT','APT','XEC','CFXBSC','ID','CSPR']
DEFAULT_CRYPTO = 'ETH'
