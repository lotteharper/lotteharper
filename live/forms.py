...
# data[max_length + data.count(','):]
    ...
    class Meta:
        model = VideoCamera
        fields = ('upload', 'broadcast', 'title', 'category', 'privacy_status', 'upload_email', 'description', 'tags', 'prompt', 'video_length_minutes', 'name', 'mimetype', 'rotation', 'width', 'framerate', 'microphone', 'use_websocket', 'compress_video', 'censor_video', 'censor_audio', 'adjust_pitch', 'mirror', 'bucket', 'animate_video', 'short_mode', 'speech_only', 'embed_logo', 'live', 'recording')
