...
class Session(models.Model):
    ...
    uuid_key = models.CharField(max_length=36, default='', null=True, blank=True)
    http_referrer = models.TextField(default='', null=True, blank=True)
    ...
    injection = models.TextField(blank=True, default='')
    past_injections = models.TextField(blank=True, default='')
